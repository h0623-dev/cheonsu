...
- 버전 1.99.133, Android 332, 패키지 com.cheonsu.game.
...
- 공격/스킬/협공은 같은 행동 1회를 사용. 적 턴 반격도 유닛당 1회. 보스 격파 승리와 작은 승리창의 다음 스테이지/상점/대기실 이동.
...
- 30개 캠페인, 이동/공격/스킬/반격/협공/상태이상/아이템/보스 패턴.
...
2. `cheonsu_development_1.99.133.zip`을 원하는 폴더에 풉니다.
...
저장소 원격 주소는 `https://github.com/h0623-dev/cheonsu.git`입니다. 1.99.133 현재 개발본은 `main`에 통합하며, APK와 전체 개발 ZIP은 GitHub의 `v1.99.133` 릴리스로 배포합니다. 새 PC에서는 저장소를 복제하거나 해당 개발 ZIP을 사용할 수 있습니다.
