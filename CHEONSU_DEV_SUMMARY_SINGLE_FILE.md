...
현재 앱/패키지 버전: `1.99.133` (Android 332)

GitHub: [현재 개발본](https://github.com/h0623-dev/cheonsu), [APK·전체 개발 ZIP 릴리스](https://github.com/h0623-dev/cheonsu/releases/tag/v1.99.133). 오래된 별도 인계 자료/미리보기는 현재 파일 목록에서 제외하고 Git 이력에 보존합니다.

최신 APK: `cheonsu_1.99.133_journey_debug.apk`. 최종 소스 빌드/서명/버전 검증 완료. APK 내부 웹 파일 1,076개가 최종 dist와 SHA-256 일치. 전체 소스는 `cheonsu_development_1.99.133.zip`. 실제 Android 기기 설치와 스피커 청음은 미검증.
